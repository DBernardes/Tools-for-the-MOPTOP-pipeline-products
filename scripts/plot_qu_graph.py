...
#         csv_file_name = os.path.join(base_path, 'Low polarized stars', star, 'all data', 'reduced', star, 'manipulated_data.csv')
...
#             inst_q, inst_std_q, inst_u, inst_std_u = qu_row['q'].values, qu_row['std_q'].values, qu_row['u'].values, qu_row['std_u'].values
